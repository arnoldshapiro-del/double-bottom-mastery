...
(function () {
  ...
  var LS_RATE = "dbm_tts_rate";
  var LS_VOICE = "dbm_tts_voice";
  ...
  var CTRL_SEL = "button,a,input,select,textarea,label,summary,[role=button],[contenteditable],.rail,.rail-item,.slot,#narrator,.sb-link,.cbtn,.q-opt,.fig-ctrls,.navbtn,.calc-row,.fig-canvas-wrap,.dstat";
